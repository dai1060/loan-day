...
//条件查询
	function seachs(){
		...
		var wstate = $('#state').combobox('getValue');
		$('#list').datagrid('load',{  
			username:username,
			wnumber:wnumber,
			wbank:wbank,
...
<body>
	<table id="list" class="easyui-datagrid" toolbar="#kj" style="width:100%" data-options="
		url:'<%=path %>/withdrawals/withdrawalsList2',
		method:'post',
		rownumbers:true,	
		singleSelect:true,
		autoRowHeight:true,
	...
	<div id="kj" style="padding: 2px;">
		...
		提现状态：<select id="state" class="easyui-combobox" name="sgstate" data-options="editable:false" style="width:10%">
