...
function loadData(){
	...
	oPage = new Page('http://120.76.203.19:8090/shzc_test/WEB-PC/app/debtsAssignmentList.do',oParam,$('.listData'),$('.paging'),oData,function(){
		queryFlag = '2';
	});
}
//获取标的状态
...
function toInvest(id,status){
	if(status!=2){return};
	window.location.href = 'http://120.76.203.19:8090/shzc_test/WEB-PC/scripts/creditor.html?id='+id;
}
//详情
